...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-4 transition-opacity duration-300 sm:p-6">
      <div className="pr-3 text-[11px] font-mono tracking-[0.24em] sm:text-sm sm:tracking-wider">
      ...
      {/* Mobile dropdown */}
      {open && (
        <nav className="absolute top-full left-4 right-4 mt-2 rounded-lg border border-white/[0.08] bg-[var(--deep-bg)]/95 px-5 py-4 backdrop-blur-md sm:hidden">
